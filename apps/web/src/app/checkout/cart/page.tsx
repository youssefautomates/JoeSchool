...
import { Lock, ShieldCheck, CreditCard, ChevronRight, ChevronDown, Loader2, ShieldAlert, Sparkles, CheckCircle2, Package, Mail, BookOpen, LayoutDashboard } from "lucide-react";
  ...
  useEffect(() => {
    async function detectCountry() {
      try {
        ...
        console.warn("Failed to detect country in cart:", err);
      }
    }
    detectCountry();
  }, []);
