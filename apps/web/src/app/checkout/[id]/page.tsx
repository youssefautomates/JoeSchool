        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="text-center space-y-5">
                  ...
                  <label className="w-full h-24 border-2 border-dashed border-white/10 hover:border-purple-500/30 rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all hover:bg-white/[0.02]">
                    ...
                    <input type="file" accept="image/*" className="hidden" onChange={async (e) => {
                      ...
                      try {
                        ...
                        const { data: urlData } = supabaseClient.storage.from('instapay-receipts').getPublicUrl(fileName);
                        setInstapayScreenshotUrl(urlData.publicUrl);
              ...
              <a 
                href={`https://wa.me/201107099196?text=${encodeURIComponent(
                  (isCourse 
                ...
                onClick={(e) => { if (!instapayScreenshotUrl) { e.preventDefault(); toast.error('يرجى رفع لقطة شاشة التحويل أولاً'); } }}
              >
