  ...
  if (phase === "loading") {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center gap-10 px-6">
        ...
        >
          <p className="font-sans text-zinc-900 text-2xl md:text-3xl font-bold mb-3 tracking-tight">
            جاري تأكيد وتفعيل مشترياتك
          </p>
          <p className="font-sans text-zinc-500 text-base md:text-lg max-w-md mx-auto leading-relaxed">
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 overflow-hidden relative font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 w-[400px] h-[400px] rounded-full bg-brand-500/5 blur-[100px]" />
      ...
      <div className="relative z-10 py-6 px-6 flex justify-start">
        <a href="/" className="group inline-flex items-center gap-3">
          ...
          <div className="flex flex-col text-right justify-center border-r border-zinc-200 pr-3 h-8">
            <span className="font-sans text-[10px] text-zinc-500 font-bold tracking-wider uppercase leading-none">Premium Store</span>
          </div>
        </a>
      </div>
      ...
      <main className="relative z-10 pb-24 pt-4">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <div className="relative">
              ...
              <div className="w-28 h-28 rounded-[2rem] bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 flex items-center justify-center shadow-[0_0_60px_rgba(16,185,129,0.35),0_20px_40px_rgba(16,185,129,0.2)] rotate-3 relative">
                <CheckCircle2 className="w-14 h-14 text-zinc-900 drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]" />
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {isHybrid ? (
              <h1 className="font-sans font-black text-3xl md:text-5xl lg:text-6xl text-zinc-900 tracking-tight leading-[1.15] mb-4">
              ...
              <h1 className="font-sans font-black text-3xl md:text-5xl lg:text-6xl text-zinc-900 tracking-tight leading-[1.15] mb-4">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 via-orange-400 to-amber-400">
                  بالدورة التدريبية 🎓
                </span>
              </h1>
            ) : (
            ...
            <p className="font-sans text-zinc-500 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
              أهلاً <span className="font-cairo font-bold text-zinc-900">{orderData?.customerName}</span>، شكراً لثقتك بنا. تم تسجيل طلبك وتجهيز كافة المحتويات الرقمية الخاصة بك.
            </p>
          </motion.div>
          ...
          {orderData?.isNewStudent && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.35 }}
              className="bg-gradient-to-br from-brand-950/20 to-orange-950/20 border border-brand-900/40 rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)]"
            >
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-2xl bg-brand-500/10 border border-zinc-200/60 flex items-center justify-center">
                  <User className="w-5 h-5 text-yellow-500" />
                </div>
                <div>
                  <h3 className="font-sans font-bold text-zinc-900 text-lg leading-snug">بيانات الحساب</h3>
                  <p className="font-alexandria text-zinc-500 text-sm">تم إنشاء حساب جديد لك. استخدم البيانات التالية لتسجيل الدخول</p>
                </div>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Email Field */}
                <div className="bg-zinc-100/30 border border-zinc-200/60 rounded-2xl p-4 space-y-2">
                  <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">البريد الإلكتروني</span>
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-zinc-900 font-mono text-sm truncate" dir="ltr">{orderData?.customerEmail}</span>
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText(orderData?.customerEmail || "");
                        toast.success("تم نسخ البريد الإلكتروني");
                      }}
                      className="text-zinc-500 hover:text-zinc-900 transition-colors p-1.5 rounded-2xl hover:bg-zinc-100/40 active:scale-95 cursor-pointer shrink-0"
                ...
                {/* Password Field */}
                <div className="bg-zinc-100/30 border border-zinc-200/60 rounded-2xl p-4 space-y-2">
                  <span className="text-[10px] text-yellow-500 font-bold uppercase tracking-wider">كلمة المرور المؤقتة</span>
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-zinc-900 font-mono text-sm truncate" dir="ltr">{orderData?.temporaryPassword}</span>
                    <button
                      onClick={() => {
              ...
              <div className="mt-4 flex items-start gap-2.5 bg-brand-950/20 border border-brand-900/30 rounded-2xl p-4">
                <Info className="w-4 h-4 text-yellow-500 shrink-0 mt-0.5" />
                <p className="text-zinc-500 text-xs leading-relaxed">
                  يرجى تغيير كلمة المرور بعد أول تسجيل دخول لحماية حسابك. يمكنك استخدام زر <strong className="text-zinc-900 font-bold">"نسخ"</strong> أعلاه لنسخ البيانات.
                </p>
              </div>
            </motion.div>
          )}
          ...
          <div className="space-y-6">
            ...
            {hasDigital && !hasCourses && (
              ...
              >
                {digitalProducts.map((p) => (
                  <div 
                    key={p.id}
                    className="bg-gradient-to-br from-white to-slate-50/60 border border-zinc-200/60 border border-zinc-200/60 rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] relative overflow-hidden group hover:border-emerald-500/30 transition-all duration-300"
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <h3 className="text-xl font-sans font-black text-zinc-900 leading-snug">{p.title}</h3>
                          
                          {/* File Details Grid */}
                          <div className="flex flex-wrap items-center gap-x-5 gap-y-1.5 pt-2 text-sm text-zinc-500 font-medium">
                            <span className="flex items-center gap-1.5">
                              <span className="text-zinc-500">نوع الملف:</span>
                              <span className="text-zinc-900 font-bold">{p.fileType}</span>
                            </span>
                            <span className="text-zinc-900/10">•</span>
                            <span className="flex items-center gap-1.5">
                              <span className="text-zinc-500">حجم الملف:</span>
                              <span className="text-zinc-900 font-bold">{p.fileSize}</span>
                            </span>
                            <span className="text-zinc-900/10">•</span>
                            <span className="flex items-center gap-1.5 text-emerald-400/90">
                              <span className="text-zinc-500">التحميل المتبقي:</span>
                              <span className="font-bold text-zinc-900">{p.remainingDownloads}</span>
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <a
                        href={p.downloadUrl || "#"}
                        className="w-full sm:w-auto h-14 px-8 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-sans font-black rounded-2xl flex items-center justify-center gap-2.5 transition-all shadow-[0_8px_30px_rgba(16,185,129,0.35)] active:scale-98 cursor-pointer shrink-0 group"
                      >
                ...
                <div className="bg-gradient-to-r from-emerald-950/30 to-teal-950/20 border border-emerald-900/40 rounded-3xl p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-emerald-400 text-base">تم الحفظ تلقائياً في حسابك</h4>
            ...
            {hasCourses && !hasDigital && (
              ...
              >
                {courses.map((c) => (
                  <div 
                    key={c.id}
                    className="bg-gradient-to-br from-white to-slate-50/60 border border-zinc-200/60 border border-zinc-200/60 rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.04)] hover:border-zinc-200/60 transition-all duration-300"
                  >
                    <div className="relative h-56 bg-zinc-900 overflow-hidden flex items-center justify-center border-b border-zinc-200/60">
                      <img 
                        src={c.image_url} 
                        alt={c.title}
                      ...
                      <div className="absolute w-40 h-40 bg-brand-600/15 rounded-full blur-3xl pointer-events-none" />
                      
                      <div className="absolute bottom-5 right-5 z-10 flex flex-wrap items-center gap-2">
                        <span className="bg-black/70 border border-zinc-200 text-zinc-900 text-[10px] px-3 py-1 rounded-xl font-bold flex items-center gap-1.5">
                    ...
                    <div className="p-6 sm:p-8 space-y-6">
                      <div className="space-y-2">
                        <span className="text-[10px] bg-brand-600/10 text-yellow-500 border border-zinc-200/60 px-2.5 py-1 rounded font-bold uppercase tracking-wider">
                          دورة تعليمية معتمدة
                        </span>
                        <h3 className="text-2xl font-sans font-black text-zinc-900 leading-tight">{c.title}</h3>
                          ...
                          return (
                            <>
                              <a
                                ...
                                className="flex-1 h-14 bg-gradient-to-r from-[#1D4ED8] to-orange-500 hover:from-[#b0003d] hover:to-orange-600 text-white font-sans font-bold text-base rounded-2xl flex items-center justify-center gap-2 shadow-[0_8px_30px_rgba(29, 78, 216,0.35)] transition-all active:scale-98 text-center group"
                              >
                              ...
                              <a
                                href={getModifiedLoginLink(orderData?.loginLink, "/dashboard")}
                                onClick={(e) => handleNavigation(e, "/dashboard")}
                                className="h-14 px-6 bg-zinc-100/40 hover:bg-zinc-100/80 text-zinc-900 font-sans font-bold text-base rounded-2xl flex items-center justify-center gap-2 border border-zinc-200 transition-colors text-center"
                              >
                ...
                <div className="bg-gradient-to-r from-brand-950/30 to-orange-950/20 border border-brand-900/40 rounded-3xl p-6 flex items-start gap-4">
                  <div className="w-10 h-10 rounded-2xl bg-brand-500/10 border border-zinc-200/60 flex items-center justify-center shrink-0">
                    <Info className="w-5 h-5 text-yellow-500" />
                  </div>
                  <div>
                    <h4 className="font-sans font-bold text-yellow-500 text-base">تم تسجيل دورتك تلقائياً</h4>
                    <p className="text-zinc-500 text-sm mt-2 leading-relaxed">
            ...
            {isHybrid && (
              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="font-sans font-bold text-emerald-400 text-lg flex items-center gap-2.5 border-b border-zinc-200/60 pb-3">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {digitalProducts.map((p) => (
                      <div 
                        key={p.id}
                        className="bg-white border border-zinc-200/60 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-emerald-500/30 hover:shadow-[0_4px_20px_rgba(16,185,129,0.1)] transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-sans font-bold text-zinc-900 text-base leading-snug">{p.title}</h4>
                            <div className="flex items-center gap-3 text-xs text-zinc-500 font-medium mt-1">
                              <span>نوع الملف: <strong className="text-zinc-900">{p.fileType}</strong></span>
                              <span>•</span>
                              <span>الحجم: <strong className="text-zinc-900">{p.fileSize}</strong></span>
                            </div>
                          </div>
                        </div>
                        ...
                        <a
                          href={p.downloadUrl || "#"}
                          className="h-12 px-6 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-sans font-bold text-xs rounded-2xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md shrink-0"
                        >
                          <Download className="w-4 h-4" />
                ...
                <div className="space-y-4 pt-2">
                  <h3 className="font-sans font-bold text-yellow-500 text-lg flex items-center gap-2.5 border-b border-zinc-200/60 pb-3">
                    <div className="w-8 h-8 rounded-2xl bg-brand-500/10 border border-zinc-200/60 flex items-center justify-center">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {courses.map((c) => (
                      <div 
                        key={c.id}
                        className="bg-white border border-zinc-200/60 rounded-2.5xl overflow-hidden flex flex-col sm:flex-row hover:border-zinc-200/60 hover:shadow-[0_4px_20px_rgba(29, 78, 216,0.1)] transition-all duration-300"
                      >
                        ...
                        <div className="p-5 flex-1 flex flex-col justify-between gap-4">
                          <div>
                            <h4 className="font-sans font-bold text-zinc-900 text-base leading-snug">{c.title}</h4>
                          ...
                          {(() => {
                            ...
                            return (
                              <a
                                href={getModifiedLoginLink(orderData?.loginLink, startLearningPath)}
                                onClick={(e) => handleNavigation(e, startLearningPath)}
                                className="h-11 bg-zinc-100/40 border border-zinc-200 hover:bg-gradient-to-r hover:from-brand-600 hover:to-orange-500 hover:border-none text-white rounded-2xl text-xs font-bold flex items-center justify-center gap-2 transition-all active:scale-98 text-center"
                              >
                ...
                <div className="bg-gradient-to-r from-sky-950/30 to-emerald-950/20 border border-sky-900/40 rounded-3xl p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-sky-400 text-base">إدارة متكاملة لمشترياتك</h4>
                    <p className="text-zinc-500 text-sm mt-2 leading-relaxed">
                    ...
                    <a
                      href={getModifiedLoginLink(orderData?.loginLink, "/dashboard")}
                      onClick={(e) => handleNavigation(e, "/dashboard")}
                      className="mt-4 h-12 px-6 bg-gradient-to-r from-sky-500 to-emerald-500 hover:from-sky-600 hover:to-emerald-600 text-white font-sans font-bold text-xs rounded-2xl inline-flex items-center justify-center gap-2 shadow-sm border border-zinc-200/60 shadow-sky-600/10 active:scale-98 transition-all text-center"
                    >
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-white/[0.02] to-white/[0.01] border border-zinc-200/60 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm border border-zinc-200/60 backdrop-blur-sm"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-sm font-medium text-zinc-500 border-b border-zinc-200/60 pb-6">
                
                {/* Meta details list */}
                <div className="space-y-5">
                  <div className="flex items-center gap-3 text-zinc-500">
                    <div className="w-9 h-9 rounded-2xl bg-zinc-100/40 border border-zinc-200 flex items-center justify-center shrink-0">
                      <User className="w-4 h-4 text-zinc-500" />
                    </div>
                    <div>
                      <span className="text-zinc-600 text-xs block mb-0.5">اسم العميل</span>
                      <span className="text-zinc-900 font-bold">{orderData?.customerName}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-zinc-500">
                    ...
                    <div>
                      ...
                      <span className="text-zinc-900 font-mono text-sm">{orderData?.customerEmail}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-zinc-500">
                    ...
                    <div>
                      ...
                      <span className="text-zinc-900 font-bold">{purchaseDate}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-3 text-zinc-500">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-zinc-900 font-mono text-sm truncate max-w-[160px]" dir="ltr">#{orderId}</span>
                        <button onClick={copyOrderId} className="text-zinc-500 hover:text-zinc-900 transition-colors cursor-pointer p-1 rounded-xl hover:bg-zinc-100/40 active:scale-95" title="نسخ المرجع">
                  ...
                  <div className="flex items-start gap-3 text-zinc-500">
                    <div className="w-9 h-9 rounded-2xl bg-zinc-100/40 border border-zinc-200 flex items-center justify-center shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      {orderData?.currency === "USD" || (orderData?.original_amount_usd && orderData.original_amount_usd > 0) ? (
                        <div className="space-y-1">
                          <span className="text-emerald-400 font-sans font-black text-lg block" dir="ltr">
                            ${Number(orderData.original_amount_usd).toFixed(2)} <span className="text-[10px] font-alexandria font-normal text-zinc-500">USD</span>
                          </span>
                          <span className="text-zinc-500 font-sans font-medium text-xs block" dir="ltr">
                        ...
                        <span className="text-emerald-400 font-sans font-black text-lg block" dir="ltr">
                          {Number(orderData?.charged_amount_egp || orderData?.amount || 0).toFixed(2)} <span className="text-[10px] font-alexandria font-normal text-zinc-500">ج.م</span>
                        </span>
                      )}
                    </div>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-5">
                <div className="flex items-start gap-3">
                  <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0 mt-0.5">
                    <Mail className="w-5 h-5 text-emerald-400" />
                  </div>
                  <div>
                    <h4 className="font-sans font-bold text-zinc-900 text-base leading-snug">وصلتك رسالة التسليم الفنية!</h4>
                    <p className="font-alexandria text-zinc-500 text-sm leading-relaxed mt-1">
                ...
                <button
                  ...
                  className="w-full sm:w-auto h-12 px-6 bg-gradient-to-r from-white/10 to-white/5 hover:from-white/15 hover:to-white/10 text-white font-sans font-bold text-xs rounded-2xl transition-all border border-zinc-200 flex items-center justify-center gap-2 disabled:opacity-50 select-none cursor-pointer shrink-0"
                >
                  {resendingEmail ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6 }}
            className="flex flex-col sm:flex-row items-center justify-center gap-6 my-8 py-6 border-y border-zinc-200/60"
          >
            {[
              ...
              <div key={label} className="flex items-center gap-2 text-zinc-500 font-sans text-xs hover:text-zinc-500 transition-colors">
                <div className="w-7 h-7 rounded-2xl bg-zinc-100/40 border border-white/[0.08] flex items-center justify-center">
          ...
          >
            <a
              href="/"
              className="inline-flex items-center gap-2 font-sans text-zinc-500 hover:text-zinc-900 transition-colors text-base group"
            >
        ...
        <div className="min-h-screen bg-white flex items-center justify-center px-6">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="text-center">
              <p className="font-sans text-zinc-900 text-lg font-bold mb-2">جاري تحميل صفحة التفعيل...</p>
              <p className="font-alexandria text-zinc-500 text-sm px-4">سيتم توجيهك إلى نتيجة الدفع في لحظات</p>
            </div>
          </div>
        </div>
      }
