  ...
  return (
    <div className="space-y-8 font-sans text-zinc-100 min-h-screen pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <tbody className="divide-y divide-white/5 text-xs">
                {funnelData.map((item) => (
                  <tr key={item.name} className="hover:bg-white/[0.01] transition-colors">
                    ...
                    <td className="py-4 text-center font-bold text-rose-400">{item.events > 0 ? "TikTok Events API + Web Pixel" : "None"}</td>
        ...
        <div className="rounded-2xl bg-[#09090e] border border-white/5 p-6 shadow-2xl flex flex-col justify-between h-fit">
          <div className="space-y-6">
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-400">TikTok Attribution & ROAS Analysis</h3>
      ...
      <div className="rounded-2xl bg-[#09090e] border border-white/5 p-8 shadow-2xl">
        <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-400 mb-8">TikTok Pixel Event Funnel Breakdown</h3>
