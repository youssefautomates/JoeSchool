      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        >
          ...
          {!isSent ? (
            <>
              <div className="mb-8">
                <h2 className="text-xl sm:text-2xl font-sans font-bold text-zinc-900 mb-2">استعادة كلمة المرور</h2>
                <p className="text-zinc-500 text-xs sm:text-sm">أدخل بريدك الإلكتروني وسنقوم بإرسال رابط آمن لإعادة تعيين كلمة مرورك فوراً.</p>
              </div>
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="font-sans font-bold text-xl text-zinc-900">تفقد بريدك الإلكتروني!</h3>
                <p className="text-zinc-500 text-sm max-w-sm mx-auto leading-relaxed">
                  لقد أرسلنا رابط إعادة تعيين كلمة المرور إلى <span className="text-yellow-500 font-bold">{email}</span>. يرجى الضغط عليه للمتابعة.
                </p>
              </div>

              <button
                onClick={() => setIsSent(false)}
                className="text-xs text-yellow-500 hover:text-brand-300 font-bold transition-all underline"
              >
          ...
          {/* Card Footer Options */}
          <div className="mt-8 pt-6 border-t border-zinc-200/60 text-center flex justify-between items-center gap-4">
            <Link href="/login" className="text-zinc-500 hover:text-zinc-900 text-xs sm:text-sm font-medium transition-colors inline-flex items-center gap-1.5">
