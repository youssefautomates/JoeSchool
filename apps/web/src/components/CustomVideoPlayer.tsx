    ...
    >
      ...
      {!hasInteracted && (
        ...
        >
          ...
          <div className="relative w-20 h-20 bg-[#D6004B] border-2 border-white/20 rounded-full flex items-center justify-center mb-4 shadow-[0_0_40px_rgba(214,0,75,0.6)] hover:scale-105 transition-transform duration-300">
